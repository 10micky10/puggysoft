...
ECHO insert Academia Tecnologica Genesis data...
mysqlsh --sql --host=%DB_HOST% -port:%DB_PORT% --user=%DB_USER% --password=%DB_PASSWORD% --database=%DB_NAME% < db-patches-insert-data-test-20-academia-tecnologica-genesis.sql
